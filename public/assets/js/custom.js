...
$(document).ready(function(){
    ...
    document.querySelectorAll(".read-more-text").forEach(p => {
        ...
        p.querySelector(".read-more-btn").addEventListener("click", function () {
            expanded = !expanded;
            ...
            p.querySelector(".read-more-btn").addEventListener("click", arguments.callee);
        });
    });
});
...
//end serch bar autocomplete
    ...
    shareOverlay.onclick = (e) => {
     ...
     document.querySelectorAll('.category-pills .btn').forEach(btn => {
        btn.addEventListener('click', function () {
            document.querySelectorAll('.category-pills .btn')
